...
@Composable
internal fun FlippingCollectionPickerSection(
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                                    ...
                                    Text(
                                        text = sf(R.string.wheel_picker_list_dish_count, collection.dishSlugs.orEmpty().size, maxDishes),
                                ...
                                Button(
                                    ...
                                    colors = ButtonDefaults.buttonColors(
                                        containerColor = if (isDisabled) MaterialTheme.colorScheme.surfaceVariant else Color(0xFFEE8B2D)
                                    )
                                ) {
